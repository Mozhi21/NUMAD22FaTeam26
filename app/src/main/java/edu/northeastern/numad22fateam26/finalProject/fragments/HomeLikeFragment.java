...
import edu.northeastern.numad22fateam26.finalProject.adapter.HomeLikeAdapter;
...
public class HomeLikeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_home_like, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new HomeLikeAdapter(list, getActivity());
        recyclerView.setAdapter(adapter);

        loadDataFromFirestore();

        adapter.OnPressed(new HomeLikeAdapter.OnPressed() {
            @Override
