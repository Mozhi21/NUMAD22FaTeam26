...
public class HomeFollowAdapter extends RecyclerView.Adapter<HomeFollowAdapter.FollowViewHolder> {
    ...
    public HomeFollowAdapter(List<HomeModel> list, Activity context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull FollowViewHolder holder, int position) {
            ...
            System.out.println(list.get(position).getUid());
